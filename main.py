...
# rework this -- have had issues in thee past
...
# this required some fixing
def run(args):
    print_every=1
    reverse, fil, n_iteration, = args.reverse, args.filter, args.iteration 
    save_every, learning_rate, n_layers, hidden_size, batch_size, beam_size = args.save, args.learning_rate, args.layer, args.hidden, args.batch_size, args.beam
    input = args.input
